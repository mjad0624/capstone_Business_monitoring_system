		...
		if(!empty($username)){
			...
			if(!empty($profile) && !empty($profile2)){
				...
				if($conn->query($query) === true){
                    ...
                    $query2 = "INSERT INTO tblbusinessinfo (`id`,`firstname`,`middlename`,`lastname`,`profile`,`gender`,`contact`,`emailadd`,`address`,`e_contact`,`e_emailadd`,`e_relationship`,`b_name`,`b_type`,`b_address`,`b_emailadd`,`b_contact`,`b_line`,`b_area`,`b_capital`,`dti_coa_number`,`tax_number`,`number_employee`,`lessor`,`l_address`,`monthly_rent`,`l_contact`) VALUES ('$id','$fname','$mname','$lname','$profile2','$gender','$number','$email','$address','$e_email','$relation','$b_name','$b_type','$b_address','$b_email','$b_number','$b_line','$b_area','$b_capital','$b_registration','$b_tax','$b_employee','$lessor','$l_address','$l_rental','$l_number')";
				...
				if($conn->query($query) === true){
                    ...
                    $query2 = "INSERT INTO tblbusinessinfo (`id`,`firstname`,`middlename`,`lastname`,`profile`,`gender`,`contact`,`emailadd`,`address`,`e_contact`,`e_emailadd`,`e_relationship`,`b_name`,`b_type`,`b_address`,`b_emailadd`,`b_contact`,`b_line`,`b_area`,`b_capital`,`dti_coa_number`,`tax_number`,`number_employee`,`lessor`,`l_address`,`monthly_rent`,`l_contact`) 
                    Values ('$id','$fname','$mname','$lname','$profile2','$gender','$number','$email','$address','$e_email','$relation','$b_name','$b_type','$b_address','$b_email','$b_number','$b_line','$b_area','$b_capital','$b_registration','$b_tax','$b_employee','$lessor','$l_address','$l_rental','$l_number')";
                    if($conn->query($query2) === true){
                        $_SESSION['message'] = 'business Information has been saved!';
                        $_SESSION['success'] = 'success';
                    }
				...
				if($conn->query($query) === true){
                    ...
                    $query2 = "INSERT INTO tblbusinessinfo (`id`,`firstname`,`midlename`,`lastname`,`profile`,`gender`,`contact`,`emailadd`,`address`,`e_contact`,`e_emailadd`,`e_relationship`,`b_name`,`b_type`,`b_address`,`b_emailadd`,`b_contact`,`b_line`,`b_area`,`b_capital`,`dti_coa_number`,`tax_number`,`number_employee`,`lessor`,`l_address`,`monthly_rent`,`l_contact`) 
                    Values ('$id','$fname','$mname','$lname','$profile2','$gender','$number','$email','$address','$e_number','$e_email','$relation','$b_name','$b_type','$b_address','$b_email','$b_number','$b_line','$b_area','$b_capital','$b_registration','$b_tax','$b_employee','$lessor','$l_address','$l_rental','$l_number')";
