...
<?php 
$business_status = $_GET['status'];
if(isset($business_status)){
    if($business_status == 'new'){
        $query = "SELECT tblbusiness.*, tbl_users.created_at FROM tbl_users INNER JOIN tblbusiness WHERE YEAR(created_at) = 2021 AND user_type = 'business' AND id = tblbusiness.business_id AND tblbusiness.business_status != 'closed'";
