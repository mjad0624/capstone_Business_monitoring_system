...
<head>
	...
	<title>Business Revenues -  Business Management System</title>
</head>
<body>
				...
				<div class="panel-header ">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white fw-bold">Business Revenues</h2>
							</div>
						</div>
					</div>
				</div>
										...
										<table id="revenuetable" class="display table table-striped">
											<thead>
												<tr>
													...
													<th scope="col">Filed Application</th>
											...
											<tbody>
												<?php if(!empty($revenuepage)): ?>
													<?php $no=1; foreach($revenuepage as $row): ?>
													<tr>
														<td><?= $row['date'] ?></td>
														<td >
