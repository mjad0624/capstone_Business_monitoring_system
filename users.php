													...
													<tr>
														...
														<td>
															<div class="avatar avatar-xs">
                                                                <img src="<?= (file_exists('assets/uploads/business_files/business_logo/'.$row['avatar']) ? 'assets/uploads/business_files/business_logo/'.$row['avatar'] : 'assets/uploads/business_files/business_logo/person.png') ?>" alt="User Profile" class="avatar-img rounded-circle">
                                                            </div>
							...
							<input type="hidden" name="size" value="1000000">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="pillSelect" required name="user_type">
										...
										<?php if($_SESSION['role'] == 'staff'|| $_SESSION['role'] == 'administrator'): ?>
